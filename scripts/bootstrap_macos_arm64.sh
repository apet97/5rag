...
if [[ "$MACHINE" != "arm64" ]]; then
    ...
    warn "Install instructions for Intel Macs are in docs/INSTALL_Intel_macOS.md"
...
echo "     python3 -m clockify_rag.cli doctor"
echo ""
echo "  3. Build the index:"
echo "     python3 -m clockify_rag.cli ingest --input ./data --output ./var/index"
echo ""
echo "  4. Start the interactive chat:"
echo "     python3 -m clockify_rag.cli chat"
echo ""
echo "📖 For more information, see:"
echo "   - docs/README.md (quickstart)"
echo "   - docs/INSTALL_macOS_ARM64.md (detailed installation guide)"
echo "   - docs/CONFIG.md (configuration options)"
echo ""

info "Troubleshooting:"
echo "  - If torch/FAISS installation fails, see: M1_COMPATIBILITY.md"
