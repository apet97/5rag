...
if [ "$SYSTEM" = "Darwin" ] && [ "$PLATFORM" = "arm64" ]; then
    ...
    echo ""
    echo "See also:"
    echo "  • M1_COMPATIBILITY.md - Full compatibility guide"
...
echo "  python3 clockify_support_cli_final.py build knowledge_full.md"
echo "  python3 clockify_support_cli_final.py chat"
echo ""
echo "For more help:"
echo "  • README.md - Main documentation"
echo "  • SUPPORT_CLI_QUICKSTART.md - Quick start (5 minutes)"
echo "  • M1_COMPATIBILITY.md - M1-specific guide (if applicable)"
echo ""
